...
partial model Partial_ControlModel3 "defines some variables used in all models"
  extends FastBuildings.Battery.Optimization.models_extra_states.Sim3;
